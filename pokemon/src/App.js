...
function App() {
  ...
  const [pressed] = React.useState(() => new Map());
  ...
  return (
    <Grid container>
      ...
      <Grid id="deck" item xs={6} >
        ...
        <CardDeck pid={0} cards={c1} oponentCard={c2} playerStats={playerStats} setPlayerStats={setPlayerStats} unfade={unfade} doUnfade={doUnfade} revealedCount={revealedCount} setRevCount={setRevCount} setGameOver={go} pressed={pressed} />
      </Grid>
      <Grid id="deck" item xs={6}>
        <Typography align="center" variant="h2" style={{ color: 'red', backgroundColor: 'yellow' }}>P2: {playerStats[1]}</Typography>
        <CardDeck pid={1} cards={c2} oponentCard={c1} playerStats={playerStats} setPlayerStats={setPlayerStats} unfade={unfade} doUnfade={doUnfade} revealedCount={revealedCount} setRevCount={setRevCount} setGameOver={go} pressed={pressed} />
      </Grid>
    </Grid>
  );
}
